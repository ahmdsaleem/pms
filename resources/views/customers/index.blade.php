    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class='input-group date'>
                    <input id="daterange" type="text" value="01/01/2015 1:30 PM - 01/01/2018 2:00 PM" class="form-control">
            ...
            <div class="form-group">
                <div class="offset-md-4 col-md-4">
                    <select id="products-filter" multiple="multiple">
            ...
            <div class="form-group">
                <div class="col-md-1">
                <button class="btn btn-success"><i class="font-icon font-icon-refresh"></i> Sync</button>
                </div>
            </div>
